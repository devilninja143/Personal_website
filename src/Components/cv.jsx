        ...
        return (
            <React.Fragment>
                <ReactToPdf targetRef={this.ref} filename="cv.pdf">
                    {({toPdf}) =>  (
                        <button className="btn btn-primary px-5" onClick={toPdf}>Downlaod</button>
                        )}
                </ReactToPdf>
                <div className="cv_cont" ref={this.ref}>
                    <div id="personal_info" className="col-auto p-3 d-flex">
                        <div id="info_cont" className=' d-flex'>
                            <div className="m-auto row col-11">
                                <div className="col-12 fs-2 text-primary p-0 text-uppercase">Nurul Hafiz Likhon</div>
                    ...
                    <div id="school_cont" className='col-11 m-auto d-flex'>
                        ...
                        <p className="col-8">
                            <div className="edu_cont">
                                <div className="label text-dark">S.S.C|Monipur Highschool and College,Ibrahimpur, Mirpur-14,Dhaka-1216</div>
                    ...
                    <div className="col-11 m-auto row skills_cont">
                        <div className="col-12">
                            <h4 className="text-primary text-uppercase mb-0">Programming Skills</h4>
                        ...
                        <div className="col-12">
                            <h4 className="text-primary text-uppercase mb-0">Language</h4>
                            <ol className="col-12 text-start">
                        ...
                        <div className="col-12">
                            <h4 className="text-primary text-uppercase mb-0">Hobbies</h4>
